...
<head>
    ...
    <title>Advocatenazmul</title>
    <meta name="description" content>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="manifest" href="site.webmanifest">
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/redoyimg/logo.png">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-2 col-lg-1 col-md-1">
                        <div class="logo">
                            <a href="index.html"><img src="assets/img/logo/logo.png" class="img-fluid"></a>
                        </div>
                    </div>
                        ...
                        <div class="main-menu f-right d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li><a href="../Case-ManageMent">Case-Management</a>
                                        <ul class="submenu">
                                            <li><a href="case_details.php">Case
                                                    Details</a></li>
                                            <li><a href="../Case-ManageMent/login.php">Case-Management Login</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
